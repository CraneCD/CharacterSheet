...
export const baseItems: BaseItem[] = [
    ...
    // TOOLS (characters can be proficient)
    { name: "Alchemist's supplies", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Brewer's supplies", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Calligrapher's supplies", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Carpenter's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Cartographer's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Cobbler's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Cook's utensils", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Glassblower's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Jeweler's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Leatherworker's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Mason's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Painter's supplies", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Potter's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Smith's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Tinker's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Weaver's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: "Woodcarver's tools", category: 'tool', description: 'These special tools include the items needed to pursue a craft or trade. Proficiency with a set of artisan\'s tools lets you add your proficiency bonus to any ability checks you make using the tools.', equipped: false, isBaseItem: true },
    { name: 'Dice set', category: 'tool', description: 'This item encompasses a wide range of game pieces, including dice and decks of cards. Proficiency with a gaming set lets you add your proficiency bonus to ability checks you make to play a game with that set.', equipped: false, isBaseItem: true },
    { name: 'Playing card set', category: 'tool', description: 'This item encompasses a wide range of game pieces, including dice and decks of cards. Proficiency with a gaming set lets you add your proficiency bonus to ability checks you make to play a game with that set.', equipped: false, isBaseItem: true },
    { name: 'Dragonchess set', category: 'tool', description: 'This item encompasses a wide range of game pieces. Proficiency with a gaming set lets you add your proficiency bonus to ability checks you make to play a game with that set.', equipped: false, isBaseItem: true },
    { name: 'Three-Dragon Ante set', category: 'tool', description: 'This item encompasses a wide range of game pieces. Proficiency with a gaming set lets you add your proficiency bonus to ability checks you make to play a game with that set.', equipped: false, isBaseItem: true },
    { name: 'Bagpipes', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Drum', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Dulcimer', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Flute', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Lute', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Lyre', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Horn', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Pan flute', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Shawm', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: 'Viol', category: 'tool', description: 'Proficiency with a musical instrument lets you add your proficiency bonus to any ability checks you make to play music with the instrument.', equipped: false, isBaseItem: true },
    { name: "Disguise kit", category: 'tool', description: 'This pouch of cosmetics, hair dye, and small props lets you create disguises that change your physical appearance. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to create a visual disguise.', equipped: false, isBaseItem: true },
    { name: "Forgery kit", category: 'tool', description: 'This small box contains a variety of papers and parchments, pens and inks, seals and sealing wax, gold and silver leaf, and other supplies necessary to create convincing forgeries of physical documents. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to create a physical forgery of a document.', equipped: false, isBaseItem: true },
    { name: "Herbalism kit", category: 'tool', description: 'This kit contains a variety of instruments such as clippers, mortar and pestle, and pouches and vials used by herbalists to create remedies and potions. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to identify or use herbs.', equipped: false, isBaseItem: true },
    { name: "Navigator's tools", category: 'tool', description: 'This set of instruments is used for navigation at sea. Proficiency with navigator\'s tools lets you add your proficiency bonus to any ability check you make to avoid getting lost at sea.', equipped: false, isBaseItem: true },
    { name: "Poisoner's kit", category: 'tool', description: 'A poisoner\'s kit includes the vials, chemicals, and other equipment necessary for the creation of poisons. Proficiency with this kit lets you add your proficiency bonus to any ability checks you make to craft or use poisons.', equipped: false, isBaseItem: true },
    { name: "Thieves' tools", category: 'tool', description: 'This set of tools includes a small file, a set of lock picks, a small mirror mounted on a metal handle, a set of narrow-bladed scissors, and a pair of pliers. Proficiency with these tools lets you add your proficiency bonus to any ability checks you make to disarm traps or open locks.', equipped: false, isBaseItem: true },
